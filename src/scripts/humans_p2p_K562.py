        ...
        for proof in proofs: 
            ...
            for balanced_train_set in balanced_train_set_list:
                ...
                for splits in ['50_50', '80_20']: 
                    ...
                    base_model_param = f"genes_19330_p2p_{SL_type}_{proof}_{SNL_type}_SNL_split_{splits}_disjoint_sets_train_{train_type}_STRING_{string_threshold}_{ana_edges}_ana_{activation}_abcm_{node_mode}_2HetConv_{heteroconv_aggr_1}_{heteroconv_aggr_2}_SAGE_{sage_aggr}_sagenorm_{sage_norm}"
                    ...
                    ## indent begins here 
                        ...
                        print("XXX" * 40)
                        if target_of_script == 'essential_K562':
                            print("This is Humans: pairs_to_pairs setting, target = SL vs SNL for the K562 cell_line.")
                        elif target_of_script == 'proven_SL':
                            print("This is Humans: pairs_to_pairs setting, target = SL vs SNL for all proven pairs in synlethdb.")
                        ...
                        size_of_batch = hyperparameters['size_of_batch']
                        # in the pairs-to-pairs setting, I do not need to use disjoint = True in the loader
                        # because the features for pairs are already 0
                        if global_loader_neighbors == 'all':
                    ...
                    f = open(file_name, "w")
                    f.write(f"This pairs_to_pairs model is trained on Humans, on K562 cells with pairs_score > {proof}:")

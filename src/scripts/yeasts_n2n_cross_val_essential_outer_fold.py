...
result_path = current_path + f'/results/yeasts/n2n/outer_cross_val/'
model_path = current_path + f'/models/yeasts/n2n/outer_cross_val/'
...
# TODO refaire mieux 
yeast_genes = pd.read_csv('/data-cbl/rnicolle/GRL4DD/data/processed/yeast_essential_nonessential_20240612.tsv', header = 0, sep = '\t')
...
# Yeasts
cross_val_dict = {
    1: 'relu_16', 2: 'relu_64', 3: 'relu_32', 4: 'relu_32', 5: 'relu_16', 6: 'relu_32', 
    7: 'relu_64', 8: 'relu_32', 9: 'relu_16', 10: 'relu_64', 11: 'relu_64', 12: 'relu_16', 
    13: 'relu_32', 14: 'relu_64', 15: 'relu_16', 16: 'relu_64', 17: 'relu_64', 18: 'relu_64', 
    19: 'relu_32', 20: 'relu_32', 21: 'relu_64', 22: 'tanh_16', 23: 'relu_32', 24: 'relu_64', 
    25: 'relu_32', 26: 'relu_64', 27: 'relu_64', 28: 'relu_32', 29: 'relu_32', 30: 'relu_64'
 }
...
for split_seed, params in cross_val_dict.items():
    ...
    model_param = f"yeasts_6579_n2n_essential_STRING_700_aggr1_{heteroconv_aggr_1}_aggr2_{heteroconv_aggr_2}_cn_2_SAGE_sageaggr_{sage_aggr}_sagenorm_{sage_norm}_batch_{size_of_batch}_trainneighbors_{neighbors}_cross_val_split_seed_{split_seed}_act_{activation}_dim_{dim}_{dim}"
